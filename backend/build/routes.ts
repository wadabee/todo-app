...
const models: TsoaRoute.Models = {
    ...
    "Partial_TodoPostParams_": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"title":{"dataType":"string"},"note":{"dataType":"string"}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "TodoPutParams": {
        "dataType": "refAlias",
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/todo',
            ...
            function TodoController_getAllTodos(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.post('/todo',
            ...
            const args = {
                    params: {"in":"body","name":"params","required":true,"ref":"TodoPostParams"},
            };
        ...
        app.put('/todo/:todoId',
            ...
            const args = {
                    ...
                    params: {"in":"body","name":"params","required":true,"ref":"TodoPutParams"},
            };
        ...
        app.post('/users',
            ...
            const args = {
                    undefined: {"in":"body","required":true,"ref":"UserPostParams"},
            };
